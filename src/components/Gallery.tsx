...
const images: GalleryImage[] = [
  ...
  { src: '/adig-champ.jpg',          caption: 'Activités agricoles et travaux champêtres des membres' },
  { src: '/adig-elevage-moutons.jpg', caption: 'Activités d\'élevage (AGR) pour les membres' },
