...
const images: GalleryImage[] = [
  ...
  { src: '/adig-familles.jpg',                   caption: 'Accompagnement des familles et bénéficiaires' },
  { src: '/adig-evenement-2020.jpg',             caption: 'Célébration de la Journée de la Santé Mentale 2020' },
  { src: '/adig-champ.jpg',                      caption: 'Protection des terres et travaux communautaires' },
  { src: '/adig-communaute.jpg',                 caption: 'Visite et suivi en milieu communautaire' },
  { src: '/adig-consultation.jpg',               caption: 'Consultation et suivi médical des bénéficiaires' },
  ...
  { src: '/adig-g2.jpg',                         caption: 'Distribution de repas lors des tournées' },
  { src: '/adig-g3.jpg',                         caption: 'Visite des responsables et partenaires' },
  { src: '/adig-g4.jpg',                         caption: 'Actions communautaires ADIG' },
  { src: '/adig-g5.jpg',                         caption: 'Soins infirmiers et suivi des malades mentaux' },
  ...
  { src: '/adig-g8.jpg',                         caption: 'Remise de vêtements et assistance aux bénéficiaires' },
  { src: '/adig-g9.jpg',                         caption: 'Groupements membres ADIG en réunion' },
  { src: '/adig-g10.jpg',                        caption: 'Séance de concertation et gouvernance ADIG' },
  { src: '/adig-g11.jpg',                        caption: 'Soins d\'hygiène corporelle et rasage de tête' },
  { src: '/adig-g12.jpg',                        caption: 'Distribution de vêtements en milieu rural' },
]
